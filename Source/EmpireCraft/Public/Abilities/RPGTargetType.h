...
class EMPIRECRAFT_API URPGTargetType : public UObject
{
	GENERATED_BODY()
...
class EMPIRECRAFT_API URPGTargetType_UseOwner : public URPGTargetType
{
	GENERATED_BODY()
...
UCLASS(NotBlueprintable)
class EMPIRECRAFT_API URPGTargetType_UseEventData : public URPGTargetType
{
	GENERATED_BODY()
